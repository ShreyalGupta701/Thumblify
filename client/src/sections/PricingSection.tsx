    ...
    return (
        <div id="pricing" className="py-20 px-6">
            <SectionTitle
                ...
                text3="Choose the perfect plan for your thumbnail creation needs."
            />
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 mt-20">
                {pricingData.map((plan: IPricing, index: number) => (
                    ...
                    >
                        {plan.mostPopular && (
                            <p className="absolute px-3 py-1 text-sm -top-3.5 left-3.5 bg-pink-400 rounded-full">
                                Most Popular
                            </p>
                        )}
